...
type Aggregator func(size int) aggregatorListType

var (
	Avg Aggregator = func(size int) aggregatorListType {
		return make(averageListType, size)
	}
	Count Aggregator = func(size int) aggregatorListType {
		return make(countListType, size)
	}
	Max Aggregator = func(size int) aggregatorListType {
		return make(maxListType, size)
	}
	Sum Aggregator = func(size int) aggregatorListType {
